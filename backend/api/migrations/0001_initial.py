    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'فعال'), ('inactive', 'غیرفعال'), ('completed', 'تکمیل شده'), ('cancelled', 'لغو شده')], default='active', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('auction_start', 'شروع مزایده'), ('auction_end', 'پایان مزایده'), ('new_bid', 'پیشنهاد جدید'), ('won_auction', 'برنده شدن در مزایده'), ('outbid', 'پیشنهاد بالاتر')], max_length=20)),
